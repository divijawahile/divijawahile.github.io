...
var typed = new Typed(".typing",{
    strings:["","MBA Student...","Aspiring Data Analyst...",],
    typeSpeed:70,
    BackSpeed:60,
    loop:true
})
...
function resume() {
    window.open("https://drive.google.com/file/d/12PlxqjqtnwspVg7dG1Jx7CJrZDQu8qks/view?usp=share_link")
}